    ...
    if not FormSubmission.query.first():
        default_submissions = [
            ...
            FormSubmission(form_id=3, user_id=138,
                           data="{\"被评议人姓名\": \"王小二\", \"（1-5评分）政治立场和理想信念\": \"1\", \"（1-5评分）工作作风和履职尽责\": \"4\", \"（1-5评分）道德品行和生活作风\": \"1\", \"你对该同志其他评价\": \"无\"}",
                           created_at=datetime(2019, 1, 1)),
            FormSubmission(form_id=3, user_id=138,
                           data="{\"被评议人姓名\": \"王小二\", \"（1-5评分）政治立场和理想信念\": \"5\", \"（1-5评分）工作作风和履职尽责\": \"4\", \"（1-5评分）道德品行和生活作风\": \"3\", \"你对该同志其他评价\": \"无\"}",
                           created_at=datetime(2020, 1, 1)),
            FormSubmission(form_id=3, user_id=138,
                           data="{\"被评议人姓名\": \"王小二\", \"（1-5评分）政治立场和理想信念\": \"4\", \"（1-5评分）工作作风和履职尽责\": \"4\", \"（1-5评分）道德品行和生活作风\": \"3\", \"你对该同志其他评价\": \"无\"}",
                           created_at=datetime(2021, 1, 1)),
            FormSubmission(form_id=3, user_id=138,
                           data="{\"被评议人姓名\": \"王小二\", \"（1-5评分）政治立场和理想信念\": \"4\", \"（1-5评分）工作作风和履职尽责\": \"3\", \"（1-5评分）道德品行和生活作风\": \"3\", \"你对该同志其他评价\": \"无\"}",
                           created_at=datetime(2022, 1, 1)),
            FormSubmission(form_id=3, user_id=138,
                           data="{\"被评议人姓名\": \"王小二\", \"（1-5评分）政治立场和理想信念\": \"5\", \"（1-5评分）工作作风和履职尽责\": \"5\", \"（1-5评分）道德品行和生活作风\": \"4\", \"你对该同志其他评价\": \"无\"}",
                           created_at=datetime(2023, 1, 1)),
            FormSubmission(form_id=3, user_id=138,
                           data="{\"被评议人姓名\": \"王小二\", \"（1-5评分）政治立场和理想信念\": \"5\", \"（1-5评分）工作作风和履职尽责\": \"5\", \"（1-5评分）道德品行和生活作风\": \"5\", \"你对该同志其他评价\": \"无\"}",
