        ...
        <div id="add-record-modal" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: var(--main-color); margin-bottom: 10px">
                        <h5 class="modal-title" style="color: white;">添加${formName}记录</h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <form id="record-form" style="display: none; width: 100%">
                            <!-- 任务关联部分 -->
                            <div class="form-group" style="justify-content: center; align-items: center">
                                <label style="width: 70px; margin-right: 5px">关联任务</label>
                                <select id="task-select" name="task_uuid" class="form-control" style="width: 90%" required>
                                    <option value="">请选择关联任务</option>
                                </select>
                            </div>
                            
                            <!-- 任务详情部分 -->
                            <div id="task-detail-container" class="task-detail-container" style="display: none; margin: 10px; padding: 5px; width: 93%">
                                <div id="task-detail-header" class="task-detail-header collapsed" style="padding: 0; margin: 0; font-size: 15px">
                                    任务详情
                                </div>
                                <div id="task-detail-content" class="task-detail-content" style="flex-direction: column">
                                    ...
                                    <div class="task-detail-row">
                                        <div class="task-detail-label">参与党组</div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-color: var(--main-color); color: white !important;">取消</button>
                        <button type="button" class="btn btn-primary" id="submit-record-btn" style="background-color: var(--main-color); color: white !important;">提交</button>
                    </div>
                </div>
            </div>
        </div>
